...
<div class="container">
    <div class="header">
        <div class="logo">⚡ Summit Digital</div>
    ...
    <div class="cta">
        ...
        <a href="PAYMENT_LINK" class="cta-btn">Get Your Full Report — $29</a>
    </div>

    <div class="footer">
        <p>Generated by Summit Digital · summitdigitalceo@gmail.com</p>
        <p>This is an automated audit. For a detailed review with prioritized recommendations, order a full report.</p>
    </div>
</div>
</body>
</html>'''
